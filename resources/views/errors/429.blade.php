...
<head>
    ...
    <title>Muitas requisições - Promoção Modelo</title>
    ...
    <div class="error-container">
        <div class="error-card">
            ...
            <p class="error-message">
                ...
                Aguarde alguns segundos antes de tentar novamente. A página
                será recarregada automaticamente.
            </p>
            <a href="javascript:location.reload()" class="btn-pm">
