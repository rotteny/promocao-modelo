...
<head>
    ...
    <title>Erro interno - Promoção Modelo</title>
    ...
    <div class="error-container">
        <div class="error-card">
            ...
            <p class="error-message">
                ...
                e está trabalhando para resolver. Tente novamente em alguns instantes.
            </p>
            <div class="d-flex gap-3 justify-content-center">
                <a href="/" class="btn-pm">
                    <i class="bi bi-house-door"></i>Ir ao Início
                </a>
                <a href="javascript:location.reload()" class="btn-pm" style="background: #6c757d;">
